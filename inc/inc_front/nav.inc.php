                    ...
                    <div class="collapse navbar-collapse" id="navbarsExample07">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item">
                                ...
                                <!-- acces aux internautes authentifiés sur le site  -->

                            <?php if(connect()) : ?>
                                <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="profil.php">Créer votre compte</a>
                            </li>

                            <?php else : ?>

                                <!-- acces aux visiteurs lambdas; non authentiés sur le site  -->
                            ...
                            <?php if(adminConnect()) : ?>
                                ...
                                <!-- acces au menu détroulant seulement pour les administrateures du site,
                            donc valeur 'admin' pour le statut dans la BDD -->
                        ...
                        <!--Exo : Afficher dans la nav la phrase "hello! nom prenom" en passant par le ficher de session de l'utilisateur  -->
                     
                       <!-- Si l'indice 'user' est definit , cela veut dire que l'internaute est passé par la page conexion et est authentifieé
                        sur le site on entre dans le if -->
                        
                        
                        <?php if(connect()) : ?>
                        
                        <span class='fst-italic'>
                            <a href='profil.php' class='text-white link-profil' 
                            title='Accès à votre compte'>Hello <?= $_SESSION['user']
                            ['prenom'] ?> <?= $_SESSION['user']['nom'] ?> !</a>
                        </span>
